...
<tr><td>
<button id='bta' type="button" onclick="proc()"><div id='ida' style="display:inline-block">実行する</div></button>
</td></tr>
</table>
</div>
...
conv={'id':'pdf表示','date':'日付','uname':'ユーザー名','loop':'検索件数','factors':'検索の重み','options':'検索条件','substance':'物質名'}
function showTable(){
const skip=[1,3,5]
const tbl = document.getElementById("retTable");
